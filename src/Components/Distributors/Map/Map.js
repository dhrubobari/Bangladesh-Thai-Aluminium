...
function Map() {
  return (
      ...
      <div className="container2">
        ...
        <div class="divisionD"><img src={dhaka} id="dhaka"/><li>Dhaka</li><div class="divisionM2"><li>Mymensingh</li></div></div>
        <div class="divisionB"><img src={barishal} id="barishal" /><li>Barishal</li></div>
